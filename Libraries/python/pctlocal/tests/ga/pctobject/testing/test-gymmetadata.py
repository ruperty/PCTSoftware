...
if test == 0:
    ...
    for env_name in envs:
        ...
        num_actions = env_info.get_num_actions()
        print("get_num_actions", num_actions)
        ...
        if env_info.is_action_array():
            if num_actions == 2:
                print("map_values_to_action_space", GymMetaData.map_values_to_action_space(env.action_space, [0.51, 2]))
            else:
