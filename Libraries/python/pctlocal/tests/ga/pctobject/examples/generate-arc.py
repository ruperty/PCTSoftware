...
python examples/generate-arc.py -f configs-simple-00000004.csv -c 00000004 -p simple-00000004 -ii 151 -mall 1 -macl 1 -pl scFitness -el 10000 -g 100 -o -a "-i 5" -pop 1000 -o >> configs/ar/cmds-simple.txt
