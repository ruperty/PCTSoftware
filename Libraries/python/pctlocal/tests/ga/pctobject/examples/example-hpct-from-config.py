...
if test==3:
    ...
    ind, score = HPCTIndividual.run_from_config(config, render=True,  error_collector_type='InputsError', error_response_type='RootMeanSquareError', error_properties=None, error_limit=100, steps=500, hpct_verbose=False)
