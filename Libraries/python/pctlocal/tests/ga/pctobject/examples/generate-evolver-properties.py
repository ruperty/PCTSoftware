...
collection = {
            'CartPoleV1': { 'arch': {
                                    ...
                                    # 'structs' : [{'mode': 0, 'types':[[HPCTLEVEL.ZEROTOP, HPCTFUNCTION.REFERENCE, HPCTVARIABLE.TYPE, 'Float', HPCTVARIABLE.FUNCTION_CLASS, 'EAConstant', HPCTVARIABLE.PROPERTIES, None],
